...
//abstract class Cake[L <: HList: *->*[LeafComponent]#](l: L) {
...
//  }
//  def unpackList[L <: HList: *->*[MyHolder]#��](l: L)(implicit mapper: shapeless.Mapper[net.homelinux.md401.deliciouslie.ShapelessTest.extractA.type, L]) =
//    l map extractA
